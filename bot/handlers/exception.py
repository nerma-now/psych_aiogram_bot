...
async def wrong_type_exception_handler(event: ErrorEvent):
    ...
    if hasattr(event, "update") and event.update.callback_query:
        await event.update.callback_query.answer(
            _("wrong_type_exception"), show_alert=True
        )
...
async def not_found_exception_handler(event: ErrorEvent):
    ...
    if hasattr(event, "update") and event.update.callback_query:
        await event.update.callback_query.answer(
            _("not_found_exception"), show_alert=True
        )
...
async def duplicative_action_exception_handler(event: ErrorEvent):
    if hasattr(event, "update") and event.update.message:
    ...
    if hasattr(event, "update") and event.update.callback_query:
        await event.update.callback_query.answer(
            _("duplicative_action_exception"), show_alert=True
        )
...
async def not_right_exception_handler(event: ErrorEvent):
    if hasattr(event, "update") and event.update.message:
    ...
    if hasattr(event, "update") and event.update.callback_query:
        await event.update.callback_query.answer(
            _("not_right_exception"), show_alert=True
        )

        return


@router.error(ExceptionTypeFilter(OneSelfException))
async def not_right_exception_handler(event: ErrorEvent):
    if hasattr(event, "update") and event.update.message:
        await event.update.message.answer(_("one_self_exception"))

        return

    if hasattr(event, "update") and event.update.callback_query:
        await event.update.callback_query.answer(
            _("one_self_exception"), show_alert=True
        )
