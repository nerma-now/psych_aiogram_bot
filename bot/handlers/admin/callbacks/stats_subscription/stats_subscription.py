...
from bot.handlers.admin.callback_factory import StatsSubscriptionCallback

from infrastructure.database.crud import SubscriptionRepository, SubscriptionPlanRepository
...
@router.callback_query(StatsSubscriptionCallback.filter(), IsAdmin(), IsSuperadmin())
async def subscription_stats_callback(
    query: CallbackQuery,
